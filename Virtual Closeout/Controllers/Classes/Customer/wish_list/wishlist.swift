...
//  Virtual Closeout
//
//  Created by Dishant Rajput on 14/05/25.
//
...
extension wishlist: UICollectionViewDelegate , UICollectionViewDataSource , UICollectionViewDelegateFlowLayout {
...
class wishlist_collection_cell: UICollectionViewCell {
