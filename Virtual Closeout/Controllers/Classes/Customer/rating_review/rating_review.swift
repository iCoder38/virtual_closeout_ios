...
//  Virtual Closeout
//
//  Created by Dishant Rajput on 15/05/25.
//
    ...
    @objc func club_review_wb() {
        ...
        ERProgressHud.sharedInstance.showDarkBackgroundView(withTitle: "Please wait...")
         ...
         if let person = UserDefaults.standard.value(forKey: "keyLoginFullData") as? [String:Any] {
            ...
            let params = customerRR(action: "reviewlist",
                                      userId: String(myString),
                                    pageNo: "1")
...
extension rating_review: UITableViewDataSource , UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        print(item as Any)
        /*
         created = "2022-07-06T12:41:33+0530";
         message = "easy delivery way";
         "profile_picture" = "https://demo2.evirtualservices.co/virtual-closeout/site/img/uploads/users/1656309765bookit_edit_profile.png";
         reviewId = 20;
         star = 3;
         userAddress = "c 34, ramprastha ";
         userId = 3;
         userName = Veeseller;
         */
        ...
        cell.imgProfile.sd_setImage(with: URL(string: (item!["profile_picture"] as! String)), placeholderImage: UIImage(named: "logo"))
